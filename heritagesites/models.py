...
class HeritageSite(models.Model):
    ...
    def region_names(self):
        ...
        :return: string
        """
        regions = self.country_area.select_related('location__region').order_by('location__region_name')
    ...
    def sub_region_names(self):
        ...
        sub_regions = self.country_area.select_related('location__sub_region').order_by('location__sub_region_name')
    ...
    def intermediate_region_names(self):
        ...
        intermediate_regions = self.country_area.select_related('location__intermediate_region').order_by('location__intermediate_region_name')
